...
public class FaceEnrollClient extends EnrollClient<ISenseService> {
    ...
    FaceEnrollClient(@NonNull Context context, @NonNull Supplier<ISenseService> lazyDaemon,
            ...
            @NonNull BiometricLogger logger, @NonNull BiometricContext biometricContext, int enrollReason) {
        super(context, lazyDaemon, token, listener, userId, hardwareAuthToken, owner, utils,
                timeoutSec, sensorId, false /* shouldVibrate */, logger, biometricContext,0);
